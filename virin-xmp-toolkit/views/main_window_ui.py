...
"}")
        ...
        self.pathLabel.setTextInteractionFlags(QtCore.Qt.TextInteractionFlag.TextEditorInteraction)
...
"")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -149, 634, 435))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"")
        ...
        self.aiScrollContents.setGeometry(QtCore.QRect(0, 0, 644, 286))
